...
import { ArrowUp, ArrowDown, Users, Mail, Target, BarChart } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-2xl p-8 text-white">
        ...
        <p className="text-purple-100 mb-6">Here's what's happening with your CRM today.</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {stats.map((stat, index) => (
          <div key={index} className="bg-white/70 backdrop-blur-sm rounded-xl p-6 border border-white/20">
            ...
            <tbody>
              {recentCampaigns.map((campaign, index) => (
                <tr key={index} className="border-b border-gray-100 hover:bg-white/50">
                  ...
                  <td className="py-4 px-4 text-gray-600">{campaign.audience.toLocaleString()}</td>
                  <td className="py-4 px-4 text-gray-600">{campaign.delivered.toLocaleString()}</td>
                  <td className="py-4 px-4">
        ...
        >
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm">Import and view customer data</p>
            </div>
          </div>
        </button>
        ...
        >
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm">Create targeted audience groups</p>
            </div>
          </div>
        </button>
